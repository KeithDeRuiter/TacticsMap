 ...
 * @author Keith
 */
public class DefaultRenderableCoordinatesProvider implements RenderableCoordinatesProvider {

    private final Map<UUID, IndividualRenderableGroupConfiguration> configs;
    
    private MapDisplay mapDisplay;
    
    public DefaultRenderableCoordinatesProvider(MapDisplay mapDisplay) {
